    ...
    do {
        ...
        switch(opcion) {
            ...
            case 4: { // Buscar persona más longeva por ciudad
                ...
                Persona encontrada = buscarLongevaCiudad(*personas, ciudadBusqueda);
                if (!encontrada.getId().empty()) {
                    encontrada.mostrar();
                } else {
            ...
            case 5: { // Buscar persona más longeva
                ...
                Persona encontrada = buscarLongevaPais(*personas);
                if(!encontrada.getId().empty()) {
                    encontrada.mostrar();
                } else {
            ...
            case 7: { // Patrimonio por pais
                ...
                Persona encontrada = mayorpatrimonioPais(*personas);
                if(!encontrada.getId().empty()) {
                    encontrada.mostrar();
                } else {
            ...
            case 8: { // Patrimonio por ciudad
                ...
                Persona encontrada = mayorpatrimonioCiudad(*personas, ciudadBusqueda);
                if(!encontrada.getId().empty()) {
                    encontrada.mostrar();
                } else {
            ...
            case 9: { // Patrimonio por calendario de declaración de renta
                ...
                Persona encontrada = mayorpatrimonioRenta(*personas, grupoCalendario);
                if(!encontrada.getId().empty()) {
                    encontrada.mostrar();
                } else {
                    std::cout << "No se encontró persona mayor patrimonio en la ciudad:" << ciudadBusqueda << "\n";
            ...
            case 11: { // Promedio de ingresos declarantes por calendario
                ...
                double encontrada = promedioIngresosCalendario(*personas, grupoCalendario);
                if (encontrada) {
            ...
            case 12: { // Edad promedio de las personas por ciudad de nacimiento
                ...
                double encontrada = promedioEdadesCiudad(*personas, ciudadBusqueda);
                if (encontrada) {
